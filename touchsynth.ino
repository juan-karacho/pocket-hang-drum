...
AudioSynthWaveform       waveform9; //xy=143,870
...
AudioSynthWaveform       waveform10; //xy=152,929
AudioSynthWaveform       waveform11; //xy=153,1006
AudioSynthWaveform       waveform8; //xy=155,788
AudioSynthWaveform       waveform3; //xy=160,384
AudioSynthWaveform       waveform12; //xy=162,1065
AudioEffectEnvelope      envelope5; //xy=331,594
AudioEffectEnvelope      envelope4; //xy=339,468
AudioEffectEnvelope      envelope9; //xy=338,871
...
AudioEffectEnvelope      envelope10; //xy=347,930
AudioEffectEnvelope      envelope11; //xy=348,1007
AudioEffectEnvelope      envelope8; //xy=350,789
AudioEffectEnvelope      envelope3; //xy=355,385
AudioEffectEnvelope      envelope12; //xy=357,1066
AudioMixer4              mixer2;         //xy=556,339
AudioMixer4              mixer3;         //xy=575,668
AudioMixer4              mixer4; //xy=582,945
...
AudioConnection          patchCord3(waveform6, envelope6);
AudioConnection          patchCord4(waveform7, envelope7);
AudioConnection          patchCord5(waveform2, envelope2);
AudioConnection          patchCord6(waveform4, envelope4);
AudioConnection          patchCord7(waveform1, envelope1);
AudioConnection          patchCord8(waveform10, envelope10);
AudioConnection          patchCord9(waveform11, envelope11);
AudioConnection          patchCord10(waveform8, envelope8);
AudioConnection          patchCord11(waveform3, envelope3);
AudioConnection          patchCord12(waveform12, envelope12);
AudioConnection          patchCord13(envelope5, 0, mixer3, 0);
AudioConnection          patchCord14(envelope4, 0, mixer2, 3);
AudioConnection          patchCord15(envelope9, 0, mixer4, 0);
AudioConnection          patchCord16(envelope6, 0, mixer3, 1);
AudioConnection          patchCord17(envelope7, 0, mixer3, 2);
AudioConnection          patchCord18(envelope2, 0, mixer2, 1);
AudioConnection          patchCord19(envelope1, 0, mixer2, 0);
AudioConnection          patchCord20(envelope10, 0, mixer4, 1);
AudioConnection          patchCord21(envelope11, 0, mixer4, 2);
AudioConnection          patchCord22(envelope8, 0, mixer3, 3);
AudioConnection          patchCord23(envelope3, 0, mixer2, 2);
AudioConnection          patchCord24(envelope12, 0, mixer4, 3);
AudioConnection          patchCord25(mixer2, 0, mixer1, 0);
AudioConnection          patchCord26(mixer3, 0, mixer1, 1);
AudioConnection          patchCord27(mixer4, 0, mixer1, 2);
...
AudioSynthWaveform *waves[12] = {
  ...
  &waveform7, &waveform8, &waveform9, &waveform10, &waveform11, &waveform12
};

AudioEffectEnvelope *envs[12] = {
  &envelope1, &envelope2, &envelope3, &envelope4, &envelope5, &envelope6,
  &envelope7, &envelope8, &envelope9, &envelope10, &envelope11, &envelope12
};
